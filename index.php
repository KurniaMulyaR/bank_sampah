...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-success">
  <div class="container">
    <div class="row">
  <a href="index.php" class="navbar-brand" href="index_user.php"><img src="img/bsip3.png"class="brand1 brand"></a>
  <button class="navbar-toggler bg-success ml-5 tggl" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a href="user/profile_bank_sampah.php" class="tggl nav-item nav-link page-scroll text-light" style="font-size: 20px;">Tentang Bank Sampah</a>
      <a href="user/login.php" class="tggl nav-item nav-link page-scroll text-light"  style="font-size: 20px;">Masuk Akun</a>
    </div>
  </div>
</div>
</div>
...
<div class="modal fade" id="angkut" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <section>
   ...
   <div class="container pb-4">
        ...
        <table class="table table-bordered table-hover mr-5"       vbbbbbbb  b>
